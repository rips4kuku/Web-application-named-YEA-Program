...
String sql = "INSERT INTO winner" + "(SLastName, SFirstName, SUserId, SDepartNo, RLastName, RFirstName, RUserId, RDepartNo, REmail, Tarea) "
 + "VALUES" + "(?,?,?,?,?,?,?,?,?,?)"; 
                      ...
                      (
                         (
                            (
                                  ...
                                  && !(radio.equals(null)|| radio.equals(""))
  )          
                                                  
{
    ...
    try
    {
        ...
        response.sendRedirect("thnx.jsp?lname="+SLastName+"&fname="+SFirstName+"&userid="+SUserId+"&deptno="+SDepartNo);
       //out.println("</script>");
...

{
 out.println("<script>");
        ...
        out.println("window.location.href = './awardwinner.jsp'");
        out.println("</script>");
        }
