...
try
{
    ...
    String query = "select SLastName, SFirstName, SUserId, SDepartNo, RLastName, RFirstName, RUserId, RDepartNo, REmail, Tarea from Awards";
...
<br>
<center><a href ="delete.jsp"><input type="submit" name="Submit" value="Delete record"></a></center><br>
<center><a href ="update.jsp" name="Submit" value="Delete">Update Record</a>
</form>
</body>
</html> 
